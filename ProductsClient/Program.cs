...
namespace ProductsClient
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ProductsServiceClient proxy = new ProductsServiceClient("BasicHttpBinding_IProductsService"); //NetTcpBinding_IProductsService //BasicHttpBinding_IProductsService
